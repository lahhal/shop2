...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # 'BASE_DIR = 'C:\work'는 manage.py가 존재하는 폴더
...
SECRET_KEY = 'de=_+^n!@z^q&7_hnf_0xpj%r7eul_dtc@+qi=f&%%@t-3m9%#'
